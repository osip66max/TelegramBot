...
public class ShowProfileHandler implements InputMessageHandler {
    ...
    public ShowProfileHandler(UserDataCache userDataCache, UserProfileDataAO userProfileDataAO,
    ...
    public SendMessage handle(Message message) {
        ...
        final UserProfileData profileData = userProfileDataAO.show(String.valueOf(message.getChatId()));
